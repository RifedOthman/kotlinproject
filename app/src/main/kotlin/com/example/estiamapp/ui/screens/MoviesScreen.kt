...
import com.example.estiamapp.ui.movies.MovieCard
        ...
        when {
            ...
            state.isEmpty -> {
                ...
                LazyColumn(
                    ...
                    itemsIndexed(visible, key = { _, m -> m.id }) { index, movie ->
                        MovieCard(movie)
